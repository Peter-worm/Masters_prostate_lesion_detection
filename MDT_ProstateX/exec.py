...
# CHANGELOG:
#
# Some numpy warnings are now filtered (although they probably shouldn't)
# Also, added in comments the possibility to generate a graph of the model
# and to run the script with the debuggin enabled (to add breakpoint() at
# point in the code to enter debugger). Both options are however commented
# by default
